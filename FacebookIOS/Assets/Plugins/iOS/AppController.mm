...
#include "../Libraries/FacebookManager.h"
...
- (void) applicationDidBecomeActive:(UIApplication*)application
{
    ...
    {
        UnityPause(false);
        [[[FacebookManager sharedManager] session] handleDidBecomeActive];
    }
...
- (void) applicationWillTerminate:(UIApplication*)application
{
    ...
    [[[FacebookManager sharedManager] session] close];
...
{
    return [[[FacebookManager sharedManager] session] handleOpenURL:url];
}
